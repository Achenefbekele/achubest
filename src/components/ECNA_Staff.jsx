...
const description = `The Ethiopian government has identified nutrition as a crucial component in preventing child and maternal deaths,
acknowledging issues such as fetal growth restriction, stunting, wasting, micronutrient deficiencies, and suboptimal
breastfeeding as significant contributors to high child morbidity and mortality.`;
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentImageIndex((prevIndex) => 
        prevIndex === staffImages.length - 1 ? 0 : prevIndex + 1
      );
    }, 3000);
          ...
          {section.staff.map((staff, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-4">
                ...
                <p className="text-sm text-center">{staff.title}</p>
              </div>
            </div>
          ))}
        </div>
