...
export default function AfarPage() {
    ...
    const images = [
        {
            id: 1,
            src: '/image/afar/National_1.jpg',
            title: '....',
            bio: `Bio to be added soon ....`
        },
        {
            id: 2,
            src: '/image/afar/National_3.jpg',
            title: 'pic...',
            bio: `Bio to be added soon.`
        },
        {
            id: 3,
            src: '/image/afar/National_4.jpg',
            title: 'pic...',
            bio: `Bio to be added soon.`
        },
        {
            id: 4,
            src: '/image/afar/National_4a.jpg',
            title: 'pic...',
            bio: `Bio to be added soon.`
        },
        {
            id: 5,
            src: '/image/afar/National_6.jpg',
            title: 'pic ...',
            bio: `Bio to be added soon.`
        }
    ];
            ...
            <main className="flex flex-col items-center min-h-screen">
                ...
                <div className="w-full bg-[#FF4719] text-white py-4 px-4">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-lg">
                            Empowering communities and fostering sustainable development in Afar
                        </p>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <h2 className="text-3xl font-bold text-[#FF4719] mb-4">Afar Region</h2>
                            <p className="text-lg">
                                The Feed the Future Ethiopia Community Nutrition Activity in Afar 
                                ...
                                and adolescent girls in the Afar region.
                            </p>

                            {showMore && (
                                <p className="text-lg animate-fade-in">
                                    In Afar, the project implements targeted interventions that 
                                    ...
                                    outcomes across the Afar region while respecting local customs 
                                    and practices.
                                </p>
                            )}
