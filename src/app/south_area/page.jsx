...
export default function SouthAreaPage() {
    ...
    const images = [
        {
            id: 1,
            src: '/image/south_area/central/Hadeya.jpg',
            title: 'South Area Team Member 1',
            bio: 'Bio description for team member 1...'
        },
        {
            id: 2,
            src: '/image/south_area/sidama/hawasa2.jpg',
            title: 'South Area Team Member 2',
            bio: 'Bio description for team member 2...'
        },
        {
            id: 3,
            src: '/image/south_area/south/Gedeo.jpg',
            title: 'South Area Team Member 3',
            bio: 'Bio description for team member 3...'
        },
        {
            id: 4,
            src: '/image/south_area/south-west/keffa.jpg',
            title: 'South Area Team Member 4',
            bio: 'Bio description for team member 4...'
        },
        {
            id: 5,
            src: '/image/south_area/sidama/hawasa2.jpg',
            title: 'South Area Team Member 5',
    ...
    const handleImageClick = (clickedImage) => {
        ...
        const index = imagesArrays.findIndex(arr => arr.some(img => img.id === clickedImage.id));
        const setCurrentIndex = [
            setCurrentImageIndex1,
            setCurrentImageIndex2,
            setCurrentImageIndex3,
        ...
        setCurrentIndex(imagesArrays[index].findIndex(img => img.id === clickedImage.id));
    };
            ...
            <main className="flex flex-col items-center min-h-screen">
                ...
                <div className="w-full bg-[#FF4719] text-white py-4 px-4">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-lg">
                            Empowering communities and fostering sustainable development in South Ethiopia
                        </p>
                    </div>
                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                {[showMore1, showMore2, showMore3, showMore4][sectionIndex] && (
                                    <p className="text-lg animate-fade-in">
                                        In the South region, the project implements targeted interventions that 
                                        address the specific nutritional challenges of the area. The 
